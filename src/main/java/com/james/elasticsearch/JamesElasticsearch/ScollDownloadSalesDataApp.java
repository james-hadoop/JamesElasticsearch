...
public class ScollDownloadSalesDataApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SearchResponse searchResponse = client.prepareSearch("car_shop").setTypes("sales")
                .setQuery(QueryBuilders.termQuery("brand.keyword", "宝马")).setScroll(new TimeValue(60000)).setSize(1)
                .get();
