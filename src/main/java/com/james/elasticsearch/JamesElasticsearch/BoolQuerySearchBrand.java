...
public class BoolQuerySearchBrand {
    ...
    public static void main(String[] args) throws Exception {
        ...
        QueryBuilder queryBuilder = QueryBuilders.boolQuery().must(QueryBuilders.matchQuery("brand", "宝马"))
        ...
        SearchResponse searchResponse = client.prepareSearch("car_shop").setTypes("cars").setQuery(queryBuilder).get();
